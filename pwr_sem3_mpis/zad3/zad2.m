...
for N = tabN
    ...
    exportgraphics(gcf, strcat('wykresyZad2/Histogram_', num2str(N), '.png'), 'Resolution', 300);
    ...
    xlabel('Wartość');
    ylabel('Dystrybuanta');
    exportgraphics(gcf, strcat('wykresyZad2/Dystrybuanty_', num2str(N), '.png'), 'Resolution', 300);
end
