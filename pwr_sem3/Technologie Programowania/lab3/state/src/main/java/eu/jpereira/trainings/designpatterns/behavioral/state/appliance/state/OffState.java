 ...
 * @author jpereira
 * 
 * DONE: Find the TODOs in this file and complete them
 *
 */
public class OffState implements ApplianceStateBehavior {
	...
	public ApplianceStateBehavior start() {
		...
		//DONE: Return a reference to this object
		return this;
	...
	public ApplianceStateBehavior turnOn() {
		...
		//DONE: Return the behavior for ON .Example: return ApplianceState.ON.getStateBehavior();
