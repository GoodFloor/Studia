 ...
 * @author jpereira
 *
 *DONE: Find TODOs in this file and complete them
 */
public class OnState implements ApplianceStateBehavior {
	...
	public ApplianceState getState() {
		//DONE: return the correnponding state enum. This represents the ON State, so return ApplianceState.ON;
	...
	public ApplianceStateBehavior start() {
		//DONE: return the STARTED Behavior ApplianceState.STARTED.getStateBehavior()
