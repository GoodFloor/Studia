 ...
 * 
 * 
 * DONE: Implement {@link CommandDirector}.
...
public class DefaulCommandDirector implements CommandDirector {
	 ...
	 */
	//DONE: Uncomment method and complete it
	@Override
	public void setFailStrategy(FailStategy strategy) {
		//DONE: Set this strategy to param strategy
	 ...
	 * .CommandDirector#run()
	 */
	//DONE: Uncomment method and complete
	@Override
	 ...
	 * .mediator.command.Command[])
	 */
	//DONE: Uncomment the following method and complet it
	@Override
	public void addCommand(Command command, Command... commands) {
		//DONE: Add the argument command to the list of commands to be executed by this CommandDirector
