...
TreeElement<Type>::TreeElement(Type element) {
    value = element;
    leftLeaf = NULL;
    rightLeaf = NULL;
}
...
template<typename Type>
bool Tree<Type>::insertElement(Type element) {
    if(root == NULL) {
...
template<typename Type>
void Tree<Type>::deleteElement(Type element) {
...
template<typename Type>
string Tree<Type>::printNode(TreeElement<Type>* node, string prefix) {
    if(node == NULL)
        return "";
    else {
...
template<typename Type>
bool Tree<Type>::search(Type searched) {
    TreeElement<Type>* node = root;
    while(node != NULL) {
