...
public class CommandDirectorTest {
	...
	protected CommandDirector createCommandDirector() {
		//DONE: 1) Go DefaultCommandDirector and follow the TODOs. Come back here and return an instance of DefaultCommandDirector 
		//return null;
		//DONE: Uncomment after complete TODO 1
